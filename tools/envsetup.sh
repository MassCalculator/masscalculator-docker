...
# This script exports the env variable MASSCALCULATOR_DOCKER_SOURCE, pointing at the 
...
MASSCALCULATOR_DOCKER_SOURCE="$(dirname "$(dirname "$(realpath "${BASH_SOURCE}")")")" > /dev/null
export MASSCALCULATOR_DOCKER_SOURCE
